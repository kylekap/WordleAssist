...
class Wordle:
    ...
    def get_words(self, *, use_local=""):
        ...
        if use_local != "":
            ...
            initial_list = requests.get(
                "https://content.instructables.com/ORIG/FLU/YE8L/H82UHPR8/FLUYE8LH82UHPR8.txt"
            ).text  # noqa: S113
    ...
    def get_inputs(self):
        ...
        while True:
            corr_pos = str(
                input(
                    "Enter letters that were in correct positions. The format should be ??a?? where 'a' was a GREEN/CORRECT letter: "
                )
            ).lower()
